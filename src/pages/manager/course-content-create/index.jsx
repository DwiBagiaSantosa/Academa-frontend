...
export default function ManageContentCreate() {
    const [initialEditor, setInitEditor] = useState('<h1>Input your content here</h1>')

    const handleOnChangeEditor = (e) => {
        setInitEditor(e.targer.value)
    }
    ...
    <>
        ...
        <form action="manage-course-materi.html" className="flex flex-col w-[930px] rounded-[30px] p-[30px] gap-[30px] bg-[#F8FAFB]">
            ...
            <div className="flex flex-col gap-[10px]">
                ...
                /> */}
                <Editor value={initialEditor} onChange={handleOnChangeEditor} />
            </div>
