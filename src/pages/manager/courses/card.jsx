  ...
  return (
    <div className="card flex items-center gap-5">
        ...
        <div className="flex justify-end items-center gap-3">
            ...
            <button onClick={handleDelete} disabled={isLoading} type="button" className="w-fit rounded-full bg-red-500 text-white p-[14px_20px] font-semibold text-nowrap">
                Delete
            </button>
