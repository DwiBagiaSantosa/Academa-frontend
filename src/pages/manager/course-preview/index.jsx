...
export default function ManageCoursePreview({isAdmin = true}) {
    const course = useLoaderData()
    // console.log("🚀 ~ ManageCoursePreview ~ course:", course)
    const {id} = useParams()
    // console.log("🚀 ~ ManageCoursePreview ~ course:", course)
    ...
    const handleNextContent = (content) => {
        const currIndex = course?.details?.findIndex((item) => item._id === content?._id)
